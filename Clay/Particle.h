...
//
//  CCParticles just destroy the framerate, so we need to create our own for simple particle effects. We don't need it to do much more than emit, move and disappear, though. Maybe have gravity.

...
- (id)init
{
    ...
    if (self) {
        ...
        EndLevelConfigureBackground(_background);
        ...
        [_facebookButton setPosition:ccp(centerX-216*MULTIPLIERX,centerY-23*MULTIPLIERY)];
        ...
        [_twitterButton setPosition:ccp(centerX-216*MULTIPLIERX,centerY-72*MULTIPLIERY)];
